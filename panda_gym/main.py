...
def main():
    ...
    # Adjust scan positions based on model complexity
    scan_positions= [
    ...
    merged_pcd = sequential_reg.hierarchical_registration(sequential_reg.source_pcd_list)
    merged_mesh = sequential_reg.generate_mesh_from_pcd(merged_pcd)
    logging.info("Mesh generation completed. Saving results...")
    sequential_reg.save_results(point_cloud=merged_pcd, mesh=merged_mesh)
